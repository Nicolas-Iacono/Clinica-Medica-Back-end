package com.backend.clinicaOdontologicaIntegrador.exceptions;
...
@RestControllerAdvice//mediante esta anotacion le digo a springBoot de que manera se van a menejar las excepciones que surjan en el controller.
